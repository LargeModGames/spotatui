...
/// The bounds [`LocalPlayer::prepare_stream`](super::player::LocalPlayer::prepare_stream)
...
/// [`LocalPlayer::prepare_stream`](super::player::LocalPlayer::prepare_stream).
...
mod tests {
  ...
  async fn live_stream_plays_through_sink() {
    use super::super::player::LocalPlayer;
    use std::time::Duration;
